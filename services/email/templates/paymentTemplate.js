const success = ({transactionId,  amount,  transactionType, transactionDate, details}) => {
    ...
    const subject = `You Have Just Received A Payment`
    ...
    <html>
        ...
        <body>
            <p>Hello there!</p>
            <p>This is to notify you that a payment has been made on your account</p>
...
const failed = ({transactionId,  amount,  transactionType, transactionDate, details}) => {
    const subject = `Your Transaction Receipt Failed`
